export default {
  state: {
    dicionario: {
      ...
      sub_titulo_pessoal: "Pessoal",
      sub_titulo_todos: "Todos",
      ...
      placeholder_select_data: "Selecione uma data",
      placeholder_select_hora: "Selecione uma hora",
